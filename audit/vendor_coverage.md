...
## Coverage Matrix (Current Status)

Status legend:
- Planned: expected to be supported with a vendor adapter
- Blocked: requires sample data / vendor SDK access
- Unknown: scope not validated yet

| Vendor        | File Type | DDA | DIA/SWATH | SRM/MRM | PRM | MALDI | MSI | Ion Mobility |
|--------------|-----------|-----|-----------|---------|-----|-------|-----|-------------|
| Thermo       | RAW       | Planned | Planned | Planned | Planned | Unknown | Unknown | FAIMS (Planned) |
| Bruker       | TDF       | Planned | Planned | Unknown | Unknown | Unknown | MSI (Planned) | TIMS (Planned) |
| SCIEX        | WIFF      | Planned | Planned | Planned | Planned | Unknown | Unknown | Unknown |
| Agilent      | D         | Planned | Planned | Planned | Planned | MALDI (Planned) | MSI (Unknown) | Unknown |
| Waters       | RAW       | Planned | Planned | Planned | Planned | MALDI (Unknown) | MSI (Unknown) | DTIMS (Planned) |
